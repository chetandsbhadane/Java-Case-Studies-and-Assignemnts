...
public class AppEngine {
	...
	public void displayEnroll(Enroll e) {
		...
		System.out.println(s.getStud_ID()+"\t\t"+s.getStud_Name()+"\t\t"+s.getStud_dob()+"\t\t"+c.getCourse_id()+"\t\t"+c.getCourse_name()+"\t\t"+c.getCourse_fees()+"\t\t"+c.getCourse_duration()+"\t\t"+e.getEntrollmentDate());
